...
public abstract class AbstractReactiveWebServerFactoryTests {
	...
	protected void testClientAuthFailure(Ssl sslConfiguration, ReactorClientHttpConnector clientConnector) {
		...
		Mono<String> result = client.post().uri("/test").contentType(MediaType.TEXT_PLAIN)
				.body(BodyInserters.fromValue("Hello World")).exchange()
				.flatMap((response) -> response.bodyToMono(String.class));
<<<<<<< /home/jonatas-clementino/Desktop/miningframework/CSDiffAnalysisAllSeparatorsTenProjectsFiveMonthsOutput/spring-boot/4ea5b89cdca46393fdf7d395cee31f9dfbdab6bf/spring-boot-project/spring-boot/src/test/java/org/springframework/boot/web/reactive/server/AbstractReactiveWebServerFactoryTests.java/left.java
		StepVerifier.create(result).expectError(WebClientRequestException.class).verify(Duration.ofSeconds(10));
||||||| /home/jonatas-clementino/Desktop/miningframework/CSDiffAnalysisAllSeparatorsTenProjectsFiveMonthsOutput/spring-boot/4ea5b89cdca46393fdf7d395cee31f9dfbdab6bf/spring-boot-project/spring-boot/src/test/java/org/springframework/boot/web/reactive/server/AbstractReactiveWebServerFactoryTests.java/base.java
...
>>>>>>> /home/jonatas-clementino/Desktop/miningframework/CSDiffAnalysisAllSeparatorsTenProjectsFiveMonthsOutput/spring-boot/4ea5b89cdca46393fdf7d395cee31f9dfbdab6bf/spring-boot-project/spring-boot/src/test/java/org/springframework/boot/web/reactive/server/AbstractReactiveWebServerFactoryTests.java/right.java
	}
